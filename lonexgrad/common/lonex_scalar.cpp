...
constexpr std::array<std::array<ScalarType, kNumScalars>, kNumScalars> promote_type_map = {{
     ...
     {kU8, kU8, kI16, kI32, kI64, kF32, kF64},
     {kI16, kI16, kI16, kI32, kI64, kF32, kF64},
     {kI32, kI32, kI32, kI32, kI64, kF32, kF64},
     {kI64, kI64, kI64, kI64, kI64, kF32, kF64},
     {kF32, kF32, kF32, kF32, kF32, kF32, kF64},
     {kF64, kF64, kF64, kF64, kF64, kF64, kF64},
}};
...
auto promote_types(ScalarType type1, ScalarType type2) -> ScalarType {
    ...
    if (idx1 >= kNumScalars || idx2 >= kNumScalars) {
        LONEXGRAD_EXCEPTION("Unknown ScalarType");
    }
