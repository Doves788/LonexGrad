...
#ifndef lonexgrad_BACKEND_CUDA_KERNEL_MATMUL_H_
#define lonexgrad_BACKEND_CUDA_KERNEL_MATMUL_H_
...
namespace lonexgrad::cuda::kernel::matmul {
...
#endif    // lonexgrad_BACKEND_CUDA_KERNEL_MATMUL_H_
