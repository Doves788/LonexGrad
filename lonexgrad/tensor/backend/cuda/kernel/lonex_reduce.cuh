...
#ifndef lonexgrad_BACKEND_CUDA_KERNEL_REDUCE_H_
#define lonexgrad_BACKEND_CUDA_KERNEL_REDUCE_H_
...
namespace lonexgrad::cuda::kernel::reduce {
...
#endif    // lonexgrad_BACKEND_CUDA_KERNEL_REDUCE_H_
