...
#ifndef lonexgrad_BACKEND_CUDA_DATATYPES_H_
#define lonexgrad_BACKEND_CUDA_DATATYPES_H_
...
namespace std {
template <typename T>
void swap(lonexgrad::cuda::DeviceMemory<T> &lhs, lonexgrad::cuda::DeviceMemory<T> &rhs) {
    lhs.swap(rhs);
}
}    // namespace std

#endif    // lonexgrad_BACKEND_CUDA_DATATYPES_H_
