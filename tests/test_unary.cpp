...
TEST_CASE("Unary sigmoid Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        CHECK(allclose(lonexgrad::sigmoid(X), expected, CloseOptions().atol(1e-6)));
    };
...
TEST_CASE("Unary logsigmoid Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::log_sigmoid(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
}
...
TEST_CASE("Unary hardsigmoid Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::hardsigmoid(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
}
...
TEST_CASE("Unary softplus Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::softplus(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
    ...
    auto test2 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::softplus(X, 0.5, 3), expected, CloseOptions().atol(1e-6)));
    };
...
TEST_CASE("Unary relu Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::relu(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
}
...
TEST_CASE("Unary relu6 Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::relu6(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
}
...
TEST_CASE("Unary leaky_relu Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::leaky_relu(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
    ...
    auto test2 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::leaky_relu(X, 0.1), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test2);
}
...
TEST_CASE("Unary elu Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::elu(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
    ...
    auto test2 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::elu(X, 2), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test2);
}
...
TEST_CASE("Unary selu Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::selu(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
}
...
TEST_CASE("Unary silu Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::silu(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
}
...
TEST_CASE("Unary hardtanh Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::hardtanh(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
    ...
    auto test2 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::hardtanh(X, -0.5, 0.5), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test2);
}
...
TEST_CASE("Unary softsign Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::softsign(X), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
}
...
TEST_CASE("Unary softmax Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::softmax(X, 0), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
    ...
    auto test2 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::softmax(X, 1), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test2);
    ...
    auto test3 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::softmax(X, 2), expected, CloseOptions().atol(1e-6)));
    };
...
TEST_CASE("Unary log_softmax Torch") {
    auto test1 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::log_softmax(X, 0), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test1);
    ...
    auto test2 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::log_softmax(X, 1), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test2);
    ...
    auto test3 = []<typename T>(Device device) {
        ...
        Tensor expected(expected_torch_data, {4, 4, 18}, device);
        CHECK(allclose(lonexgrad::log_softmax(X, 2), expected, CloseOptions().atol(1e-6)));
    };
    runner_single_type<float>(test3);
}
#endif
